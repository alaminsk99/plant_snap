...
class PTextStrings{
  ...
  /// Home Screen
  static const String homeScreenBodyTitleText = "Upload a Plant Image";
  static const String homeScreenBodySubTitleText = "Take a photo or select from gallery to identify the plant";
